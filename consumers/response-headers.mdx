...
- **X-Jojapi-Gateway-Response**: This header only takes the value “true”. The presence of this header in the request indicates that the response body was created by the gateway. Read [<u>this</u>](https://docs.jojapi.com/responses-generated-by-gateway/) article to see details about the bodies created by the gateway.
