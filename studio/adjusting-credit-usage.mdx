...
To determine credit usage in [SSE responses](https://developer.mozilla.org/en-US/docs/Web/API/Server-sent_events/Using_server-sent_events) (must be `content-type: text/event-stream`), you can send a message like the following.
